...
INSERT INTO Posts (post, userID, topicID)
  ...
  ('One of my boys needed to lose some weight and the other didn''t. I put this food on the floor for the chubby guy, and the protein-rich, no by-product food up higher where only my skinny boy can jump. ...', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('My cats have been happily eating Felidae Platinum for more than two years. I just got a new bag and the shape of the food is different. They tried the new food when I first put it in their bowls and n...', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('good flavor! these came securely packed... they were fresh and delicious! i love these Twizzlers!', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('The Strawberry Twizzlers are my guilty pleasure - yummy. Six pounds will be around for a while with my son and I.', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('My daughter loves twizzlers and this shipment of six pounds really hit the spot. It''s exactly what you would expect...six packages of strawberry twizzlers.', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('I love eating them and they are good for watching TV and looking at movies! It is not too sweet. I like to transfer them to a zip lock baggie so they stay fresh so I can take my time eating them.', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('I am very satisfied with my Twizzler purchase. I shared these with others and we have all enjoyed them. I will definitely be ordering more.', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('Twizzlers, Strawberry my childhood favorite candy, made in Lancaster Pennsylvania by Y & S Candies, Inc. one of the oldest confectionery Firms in the United States, now a Subsidiary of the Hershey Com...', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('Candy was delivered very fast and was purchased at a reasonable price. I was home bound and unable to get to a store so this was perfect for me.', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('My husband is a Twizzlers addict. We''ve bought these many times from Amazon because we''re government employees living overseas and can''t get them in the country we are assigned to. They''ve always be...', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('I bought these for my husband who is currently overseas. He loves these, and apparently his staff likes them also.<br />There are generous amounts of Twizzlers in each 16-ounce bag, and this was well ...', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('I can remember buying this candy as a kid and the quality hasn''t dropped in all these years. Still a superb product you won''t be disappointed with.', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('I love this candy. After weight watchers I had to cut back but still have a craving for it.', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('I have lived out of the US for over 7 yrs now, and I so miss my Twizzlers!! When I go back to visit or someone visits me, I always stock up. All I can say is YUM!<br />Sell these in Mexico and you w...', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('Product received is as advertised.<br /><br /><a href="http://www.amazon.com/gp/product/B001GVISJM">Twizzlers, Strawberry, 16-Ounce Bags (Pack of 6)</a>', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('The candy is just red , No flavor . Just plan and chewy . I would never buy them again', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('I was so glad Amazon carried these batteries. I have a hard time finding them elsewhere because they are such a unique size. I need them for my garage door opener.<br />Great deal for the price.', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('I got this for my Mum who is not diabetic but needs to watch her sugar intake, and my father who simply chooses to limit unnecessary sugar intake - she''s the one with the sweet tooth - they both LOVED...', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food')),
  ('I don''t know if it''s the cactus or the tequila or just the unique combination of ingredients, but the flavour of this hot sauce makes it one of a kind! We picked up a bottle once on a trip we were on...', 1, (SELECT topicID FROM Topics WHERE topicName = 'Food'));
